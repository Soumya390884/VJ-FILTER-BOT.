...
API_ID = int(environ.get('26542274', ''))
API_HASH = environ.get('5d93f4663a824dcc11b308bbbd5f589b', '')
...
LOG_CHANNEL = int(environ.get('2207733248', ''))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6681066457').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '2231951672').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '6503276372')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '2231951672')).split()]
